"""실행 중인 Weather MCP  Tool로 사용될 LangGraph 기반 Agent """
# from langchain_mcp_adapters.client import MultiServerMCPClient
# ->> 이건 하나의 Agent안에 서버 두개 돌릴떄 알아서 선택하게 해주는 라이브러리 근데 안쓸꺼(복잡함)
...
async def build_agent():
    ...
    if not os.getenv("OPENAI_API_KEY"):
        raise RuntimeError("OPEN API KEY 누락")
    ...
    return create_agent(
        ...
        system_prompt = (
            ...
            "현재 날씨 조회는 get_current_weather_cia_mcp를 사용한다."
...
# LLM이 사용자 질문에 맞춰 알아서 MCP 를 호출할 수 있게 함
